...
export const ADD_ALARM_SYS = 'ADD_ALARM_SYS';
export const UPDATE_ALARM_SYS = 'UPDATE_ALARM_SYS';
export const GET_AS_INSP = 'GET_AS_INSP';
export const ADD_AS_INSP = 'ADD_AS_INSP';
