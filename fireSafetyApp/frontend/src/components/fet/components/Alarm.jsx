...
const rows = [
  createData(6, 'F1', '17 Feb 20', '17 Jan 20', 'Jim'),
  createData(7, 'F2', '18 Feb 20', '18 Jan 20', 'Steve'),
  createData(8, 'F3', '19 Feb 20', '19 Jan 20', 'Charles'),
  createData(9, 'F4', '20 Feb 20', '20 Jan 20', 'Jim'),
  createData(10, 'F5', '21 Feb 20', '21 Jan 20', 'Jim'),
];
